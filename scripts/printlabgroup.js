...
function fillRoll() {
  ...
  if (
    ...
    roll_lab_group_value >= 2108001 &&
    roll_lab_group_value <= 2108060
  ) {
    var team_member_last_roll =
      Math.ceil(parseInt(roll_lab_group_value.slice(4, 7)) / 5) * 5 + 2108000;
    var roll_list = [];
...
async function MakeLabCoverGroup() {
  ...
  if (
    ...
    parseInt(rollNumber) >= 2108001 &&
    parseInt(rollNumber) <= 2108060 &&
    parseInt(rollNumber2) >= 2108001 &&
    parseInt(rollNumber2) <= 2108060 &&
    parseInt(rollNumber3) >= 2108001 &&
    parseInt(rollNumber3) <= 2108060 &&
    parseInt(rollNumber4) >= 2108001 &&
    parseInt(rollNumber4) <= 2108060 &&
    parseInt(rollNumber5) >= 2108001 &&
    parseInt(rollNumber5) <= 2108060
  ) {
    saveRolls();
